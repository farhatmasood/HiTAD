"""
HiTAD Evaluation Script
============================

Evaluate a trained HiTAD checkpoint on a dataset split.
...
from hitad.utils.metrics import compute_ap, compute_metrics
from hitad.utils.visualization import plot_predictions


def parse_args():
    p = argparse.ArgumentParser(description="Evaluate HiTAD")
...
def main():
    ...
    print("\n" + "=" * 70)
    print(f"HiTAD {args.model.upper()} Evaluation")
    print("=" * 70)
