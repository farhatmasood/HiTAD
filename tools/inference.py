...
from hitad.data.dataset import CLASS_NAMES
from hitad.utils.decode import decode_predictions
from hitad.utils.visualization import draw_predictions, plot_predictions


def parse_args():
    p = argparse.ArgumentParser(description="HiTAD Inference")
...
def load_model(variant, ckpt_path, num_classes, image_size, device):
    if variant == "v1":
        ...
        from hitad.models.hitad_v2 import build_model as _bv2
