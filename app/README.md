...
**A Streamlit-based demonstration application for the [HiTAD](https://github.com/farhatmasood/HiTAD) framework.**
...
| `rf-detr*.pth` | RF-DETR | ✅ |
| `hitad.pt`, `ys.pt` | HiTAD (custom / Ultralytics) | ✅ |
...
If you use this application in your research, please cite the HiTAD paper:
