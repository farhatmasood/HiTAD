"""
HiTAD V2: Two-Stage Spinal Disorder Detection Model
=========================================================
...
class HiTADV2(nn.Module):
    """
    Two-stage HiTAD detector (DDE + MLDR).
...
def build_model(num_classes=6, image_size=384):
    """Construct a HiTADV2 model instance."""
    return HiTADV2(num_classes=num_classes, image_size=image_size)
