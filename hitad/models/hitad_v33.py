"""
HiTAD V3.3: DenseC2f Architecture with Improved Normalization
==================================================================
...
class HiTADV33(nn.Module):
    """
    HiTAD V3.3 with DenseC2f blocks and improved normalization.
...
if __name__ == "__main__":
    ...
    model = HiTADV33(num_classes=6).to(device)
