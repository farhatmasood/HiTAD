"""
Two-stage detection loss for HiTAD V2 (DDE + MLDR).
...
The ``HiTADLoss`` class combines both stages with configurable
...
class HiTADLoss(nn.Module):
    """
    Combined loss for HiTAD V2 (DDE + MLDR).
